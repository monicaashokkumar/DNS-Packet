...
responseFlagFilter1[10] -> Print('Response Opcode: Inverse Query Response, AA: Not an authoritative server, TC: Message Truncated, RD: Client does not need a recursive answer') -> responseFlagFilter2;          
